...
@include('layouts.message')
    ...
    <h2 class="font-bold text-4xl text-black-700 mx-2">Categories</h2> 
    ...
    <table id="mytable" class="display">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$category->name}}</td>
                <td>
                    <a href="{{route('category.edit',$category->id)}}" class="bg-blue-600 text-white px-2 py-1 rounded shadow hover:shadow-blue-400"> <i class="fas fa-edit"></i></a>
                    ...
                    <a onclick="showDelete('{{$category->id}}')" class="bg-red-600 text-white px-2 py-1 rounded shadow hover:shadow-red-400 cursor-pointer">
